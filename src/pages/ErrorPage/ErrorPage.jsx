    ...
    <div className="max-w-[350px] md:max-w-[750px] lg:max-w-[1210px] mx-auto mt-20">
      <div className="relative">
        ...
        <div className="md:ml-auto lg:ml-auto absolute top-60 md:top-52 lg:top-52 left-0 md:right-0 lg:right-0 w-[350px] md:w-[500px] lg:w-[500px]">
          {" "}
          <h1 className="text-[190px] md:text-[250px] lg:text-[250px] font-black text-[#FA6410]">
            404
          </h1>
          ...
          <button className="border rounded-[18px] px-[40px] lg:px-[54px] py-[20px] lg:py-[26px] flex justify-center items-center gap-1 bg-[#FA6410] text-white hover:bg-paragraphColor hover:text-white mt-8 text-xl mx-auto lg:mx-0">
            <MdArrowBack />
